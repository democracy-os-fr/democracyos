...
module.exports = exports = function models () {
  ...
  const connection = mongoose.createConnection(config.mongoUrl, { useNewUrlParser: true })
  ...
  const usersDb = hasUsersDb
    ? mongoose.createConnection(config.mongoUsersUrl, { useNewUrlParser: true })
    : connection
  ...
  exports.Group = require('./group')(connection)
