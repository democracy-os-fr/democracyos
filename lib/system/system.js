...
import Group from './groups/group-create'
import GroupUpdate from './groups/group-update'
...
import HubInfo from './hub/hub-info'
import HubFAQ from './hub/hub-faq'
import HubGroupHelp from './hub/hub-group-help'
import HubParticularHelp from './hub/hub-particular-help'
/**
...
page(urlBuilder.for('system.hub.group.help'), (ctx) => {
  render(<HubGroupHelp />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.hub.particular.help'), (ctx) => {
  render(<HubParticularHelp />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.hub.info'), (ctx) => {
  render(<HubInfo />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.hub.faq'), (ctx) => {
  render(<HubFAQ />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.upload'), (ctx) => {
  render(<AdminUpload />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.groups'), (ctx) => {
  render(<Groups />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.groups.create'), (ctx) => {
  render(<Group />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.groups.update'), (ctx) => {
  render(<GroupUpdate />, document.querySelector('#system-content'))
})
page(urlBuilder.for('system.groups.view'), (ctx) => {
  render(<GroupView />, document.querySelector('#system-content'))
})
