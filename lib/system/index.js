...
app.get(urlBuilder.for('system.groups'), visibility, action)
app.get(urlBuilder.for('system.groups.create'), visibility, action)
app.get(urlBuilder.for('system.groups.update'), visibility, action)
app.get(urlBuilder.for('system.groups.view'), visibility, action)
app.get(urlBuilder.for('system.hub.info'), visibility, action)
app.get(urlBuilder.for('system.hub.faq'), visibility, action)
app.get(urlBuilder.for('system.hub.group.help'), visibility, action)
app.get(urlBuilder.for('system.hub.particular.help'), visibility, action)
