...
export default class ForumCard extends Component {
  ...
  render () {
    let backgroundGradient = 'linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.95))'
    let backgroundStyle = this.props.forum.coverUrl ? {
      backgroundImage: [
        backgroundGradient,
            ...
            <table>
              <thead>
                <tr>
                  ...
                  {this.props.user && this.props.user.staff && (
