...
export default class ForumCard extends Component {
  ...
  componentWillMount () {
    ...
    if (this.state.showStats) this.displayStats()
  }
            ...
            <table>
              <thead>
                <tr>
                  ...
                  { this.state.showStats && (<th className='info-topics'>{topics}</th>)}
                  { this.state.showStats && (<th className='info-participants'>{participants}</th>)}
                </tr>
              </thead>
            </table>
          </div>
