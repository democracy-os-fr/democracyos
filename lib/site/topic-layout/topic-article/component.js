  ...
  render () {
    ...
    if (topic.action.method) {
      switch (topic.action.method) {
        case 'vote':
          action = (
            <Vote topic={topic} user={user} canVoteAndComment={forum.privileges.canVoteAndComment} />
          )
          break
        case 'poll':
          action = (
    ...
    let showComments = !topic.attrs || !topic.attrs.disableComments
    ...
    return (
      <div className='topic-article-wrapper'>
        ...
        {action}
        <Social topic={topic} user={user} />
        {
          !user.state.pending && showComments && <Comments forum={forum} topic={topic} />
        }
        { topic.attrs && topic.attrs.polisID && (
          <div
            className='polis'
