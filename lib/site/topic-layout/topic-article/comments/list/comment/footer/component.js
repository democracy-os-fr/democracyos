...
export default function CommentFooter (props) {
  ...
  const showReplyTooltip = (
    <Tooltip id='replyTooltip'>
      {t('comments.arguments.show-reply')}
    </Tooltip>
  )
  ...
  const isPrivate = props.forum.visibility === 'private'
    ...
    <footer className='actions'>
      <div className='votes'>
        <button
          ...
          disabled={props.readOnly || props.isOwner}
      ...
      <div className='replies-score'>
        ...
        {(!!props.comment.repliesCount || !props.readOnly) && (
          <OverlayTrigger placement='left' overlay={props.readOnly ? showReplyTooltip : replyTooltip}>
