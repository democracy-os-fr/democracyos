...
// const log = debug('democracyos:hub:groups')
        ...
        <div className='list-groups'>
          {this.state.groups.map((group) =>
            <div key={group.id} className='list-group'>
              <a href={urlBuilder.for('site.hub.group.view', { id: group.id })}>
                <img className='logoImage' src={group.logoUrl || '/lib/boot/groups.png'} />
          ...
          {!this.state.noMore && (
            <div className='load-more'>
              {!this.state.loading && (
                <button onClick={this.handleLoadMore} className='btn btn-sm btn-block'>
                  {!this.state.loaded && (
              ...
              {this.state.loading && (
                <button className='loader-btn btn btn-sm btn-block'>
