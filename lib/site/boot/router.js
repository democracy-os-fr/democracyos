import HubHome from 'lib/site/home-hub/component'
...
import HubParticularHelp from '../help/hub/hub-particular-help'
...
export default {
  ...
  childRoutes: [
    ...
    { path: urlBuilder.for('site.hub.particular.help'), component: HubParticularHelp },
