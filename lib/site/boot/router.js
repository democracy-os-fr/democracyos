...
// import Home from 'lib/site/home/component'
import HubHome from 'lib/site/hub/component'
...
import GroupSection from 'lib/site/hub/group/component'
import GroupView from 'lib/site/hub/group/view'
import HubFAQ from '../help/hub/hub-faq'
import HubInfo from '../help/hub/hub-info'
import HubSoloHelp from '../help/hub/hub-solo-help'
import HubGroupHelp from '../help/hub/hub-group-help'
...
export default {
  path: '/',
  component: Layout,
  indexRoute: { component: config.multiForum ? HubHome : HomeForum },
  childRoutes: [
    ...
    { path: urlBuilder.for('site.hub.faq'), component: HubFAQ },
    { path: urlBuilder.for('site.hub.info'), component: HubInfo },
    { path: urlBuilder.for('site.hub.solo.help'), component: HubSoloHelp },
    { path: urlBuilder.for('site.hub.group.help'), component: HubGroupHelp },
    { path: urlBuilder.for('site.hub.group.all'), component: GroupSection },
    { path: urlBuilder.for('site.hub.group.view'), component: GroupView },
    ...
    { path: urlBuilder.for('system'), component: reload },
    { path: urlBuilder.for('system.wild'), component: reload },
    config.multiForum ? {
