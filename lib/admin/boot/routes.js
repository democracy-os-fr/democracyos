...
module.exports = function adminRoutes (multiForum) {
  ...
  urlBuilder.register('admin.general', forum + '/admin/general')
  urlBuilder.register('admin.tags-moderation', forum + '/admin/tags-moderation')
  urlBuilder.register('admin.upload', forum + '/admin/upload')
  urlBuilder.register('admin.upload.jpg', forum + '/api/v2/upload.jpg?forum=:forum')
}
