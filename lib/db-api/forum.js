...
/**
 * Get forums form `group` string or `ObjectId`
 *
 * @param {String|ObjectId} group group's `id`
 * @param {Function} fn callback function
 *   - 'err' error found while process or `null`
 *   - 'forum' found item or `undefined`
 * @api public
 */

exports.findByGroup = function findByGroup (groupId, fn) {
  log('Searching forums of group %j', groupId)

  Forum
    .where({ associationId: groupId, deletedAt: null })
