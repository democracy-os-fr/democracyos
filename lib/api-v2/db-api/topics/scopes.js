...
exports.ordinary.populate = [
  ...
  {
    path: 'tag',
    select: 'id hash name color icon image'
  }
]
...
exports.listing.select = exports.listing.keys.expose.concat(
  exports.listing.keys.select
).join(' ')

exports.listing.expose = (function () {
  const exposeFields = expose(exports.listing.keys.expose)
