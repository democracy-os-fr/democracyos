...
app.post('/forum/copy', middlewares.canCreateForum, restrict, maintenance, function (req, res) {
  ...
  var data = {
    ...
    creationReason: req.body.creationReason,
    justificatoryUrl: req.body.justificatory,
    name: req.body.name,
    title: req.body.title,
    owner: req.user._id,
    body: req.body.body,
...
app.post('/forum/:id',
  ...
  function (req, res) {
    ...
    updateJustificatoryUrl(req, req.body)
...
function updateJustificatoryUrl (req, data) {
  data.justificatoryUrl = req.body.justificatory
}
